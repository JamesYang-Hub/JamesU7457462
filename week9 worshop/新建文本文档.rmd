...
```{r sampldistZr}
#?
ggplot2::ggplot(tibble(means), aes(x = means)) + geom_histogram(binwidth = 0.02) +
    geom_vline(xintercept = 10.8, col = "red") + geom_vline(xintercept = mean(means),
    col = "blue", linetype = 2)
